...
const ContactsModal = memo(({ contacts, open, onClose }) => {
    const { instagram, vkontakte, telegram } = contacts;

    return (
        <Modal className='fade' open={open} onClose={onClose} contentClassName='contacts-modal'>
            <h5 className='mb-4'>Контакты</h5>
            <div className='contacts-modal__inner'>
                {instagram ? (
                    <div className='contacts-modal__block contacts-modal__block-instagram'>
                ...
                {vkontakte ? (
                    <div className='contacts-modal__block contacts-modal__block-vkontakte'>
                ...
                {telegram ? (
                    <div className='contacts-modal__block contacts-modal__block-telegram'>
...
export default dynamic(() => Promise.resolve(ContactsModal), {
    ssr: false
});